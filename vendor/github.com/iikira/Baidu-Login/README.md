...
[![GoDoc](https://godoc.org/github.com/qjfoidnh/Baidu-Login?status.svg)](https://godoc.org/github.com/qjfoidnh/Baidu-Login)
...
#### 编译安装(需要设置GOPATH环境变量)
```shell
go get -u -v github.com/qjfoidnh/Baidu-Login/cmd/Baidu-Login
```
